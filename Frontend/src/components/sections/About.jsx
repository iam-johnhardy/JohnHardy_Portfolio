          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
            <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
              ...
              <ul className="list-disc list-inside text-gray-300 space-y-2">
                <li>
                  <strong> H.N.D </strong> - Benue State Polytechnic Ugbokolo, Benue State.
                  (2020-2023)
                </li>
                 <li>
                    <strong>Web Development</strong> - Aptech Computer Education.
                  (2023)
                </li>
                <li>
                  Relevant Coursework: Web Development, Cloud
                  Computing...
                </li>
              </ul>
            </div>
              ...
              <div className="space-y-4 text-gray-300">
                <div>
                  <h4 className="font-semibold">
                    {" "}
                    Software Instructor at Aptech Computer Eduction (2025 - Present){" "}
                  </h4>
                  <p>
