  ...
  />
      <RevealOnScroll>
        <div className=" text-center z-10 px-4 ">
          <h1 className="relative text-5xl md:text-7xl font-bold z-50 mb-6 bg-gradient-to-r from-blue-500 to-cyan-400 bg-clip-text text-transparent leading-right opacity-100">
            Hi, I'm John Hardy
          </h1>
